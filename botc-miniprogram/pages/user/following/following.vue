<template>
  <view class="page">
    <!-- 关注列表 -->
    <view v-if="followingList.length > 0" class="user-list">
      <view 
    ...
    <view v-else class="empty-state">
      ...
      <text class="empty-hint">快去关注你感兴趣的玩家吧</text>
    </view>
    ...
    <!-- 没有更多 -->
    <view v-if="!hasMore && followingList.length > 0" class="no-more">
      <text>没有更多了</text>
    </view>
  </view>
</template>
      ...
      try {
        ...
        if (result.code === 0) {
          ...
          if (this.page === 1) {
            ...
            this.followingList = [...this.followingList, ...list]
          }
